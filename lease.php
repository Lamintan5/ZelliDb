<?php
    ...
    if('GET_MY' == $action){
        ...
        $uid = $_POST['uid'];
        $query = "SELECT * FROM $table WHERE FIND_IN_SET('" . $uid . "', tid) OR FIND_IN_SET('" . $uid . "', pid)";
    ...
    if('ADD' == $action){
        ...
        if($count>=1){
            ...
            $sql = "INSERT INTO $table (lid, tid, ctid, eid, uid, pid, start, end) VALUES('$lid','$tid','','$eid','$uid','$pid','$start','$end')";
